...
The output from `aggregate_TEMPO.R`  are hourly data, and it can be avaraged using the `ncea` command:
```sh
...
```
![*Figure 1* - TEMPO HCHO for 2023-07.](https://raw.githubusercontent.com/schuch666/TEMPO_training/master/FIG/tempo_hcho_2023-07.png)
